...
namespace ECommerce.UserService.BusinessLogic.Managers
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void PublishNewUser(RegistrationRequestViewModel userViewModel)
        {
            userViewModel.Event = "User_Published";
            var message = JsonSerializer.Serialize(userViewModel);
